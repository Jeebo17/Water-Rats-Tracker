...
import { getLeaders } from '../util/leaders';
import { getSessions } from '../util/sessions';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Leaders</h1>
          <p className="text-gray-600 text-sm sm:text-base">View all leaders and their upcoming sessions</p>
        </div>
      </div>
        ...
        <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center space-x-2 flex-wrap">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800">{leader.name}</h3>
              {leader.youngLeader && (
      ...
      <div className="space-y-3 mb-4">
        {leader.email && (
          <div className="flex items-center text-gray-600 min-w-0">
            ...
            <span className="truncate text-sm">{leader.email}</span>
          </div>
        )}
        {leader.phone && (
