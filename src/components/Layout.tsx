        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Session Management</p>
              </div>
            </div>
            ...
            <div className="hidden md:flex space-x-2">
              ...
              <NavItem to="/instructors" icon={<UserCheck className="w-4 h-4" />} label="Instructors" />
          ...
          <div className="md:hidden pb-4">
            <div className="grid grid-cols-2 gap-2">
              <NavItem to="/" icon={<Home className="w-4 h-4" />} label="Dashboard" mobile />
              <NavItem to="/sessions" icon={<Calendar className="w-4 h-4" />} label="Sessions" mobile />
              <NavItem to="/instructors" icon={<UserCheck className="w-4 h-4" />} label="Instructors" mobile />
              <NavItem to="/destinations" icon={<MapPin className="w-4 h-4" />} label="Destinations" mobile />
            </div>
            <div className="grid grid-cols-1 gap-2 mt-2">
              <NavItem to="/finances" icon={<PoundSterling className="w-4 h-4" />} label="Finances" mobile />
            </div>
          </div>
        </div>
      </nav>
